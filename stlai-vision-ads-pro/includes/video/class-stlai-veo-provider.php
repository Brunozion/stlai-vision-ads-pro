...
class STLAI_Veo_Provider {
    ...
    private static function build_prompt_package( array $payload ) {
        ...
        if ( '16:9' === $format ) {
            $format_direction = 'Horizontal 16:9 commercial product video. Use the prepared 16:9 frame as the exact visual reference. The first frame must show the full product clearly: top, full body, base, sides, edges and all important details. Do not start cropped in. Do not cut off the product, head, body, base, sides, edges or important details. If needed, move the camera farther away before starting the shot so the entire product fits safely inside the frame. Begin with a full product view, then use only subtle realistic motion while keeping the product visible and recognizable. Avoid aggressive zoom. Avoid close-up as the first frame. Avoid crop. Avoid sudden reframing. Use a realistic product-filming style, as if a person is naturally filming the product in a real scene. Prefer eye-level or slight three-quarter product angles. Avoid top-down camera moves, strong overhead angles, vertical camera drops, synthetic zoom-only motion and aggressive push-ins at the start. Use subtle handheld-like or dolly-like camera motion with gentle parallax across the full scene. Center the product or place it cleanly on rule of thirds with safe space above, below and on both sides. Preserve the product exactly. The background can have natural movement, but the product must not change. Keep the wedding atmosphere elegant, soft and believable. Avoid excessive candles, visual clutter, random props or unnecessary decorative objects. Use subtle tasteful wedding context only when visually coherent. Do not add black bars. Do not create a blurred artificial canvas. Do not change the product to fill the frame.';
            $format_safety_lock = '16:9 strict product identity lock: The product shown in the source image is the exact product that must appear in the final video. Use the uploaded source image as the strict visual anchor. The product must remain identical to the reference image. Do not generate alternate versions of the product. Do not stylize the product differently. Do not simplify or mutate the character. Do not replace facial details. Do not alter the hairstyle or hair color. Do not change the couple’s appearance. Do not modify the base, cake, clothing, structure, material, texture, accessories, proportions, face, skin tone or identity. The product characters must have complete and intact facial features. Preserve eyes, nose, mouth, face structure and all facial details. Do not remove eyes. Do not generate missing eyes. Do not simplify or distort the face. Preserve full facial integrity in every frame. The product must remain exactly the same in every frame and in every clip. Preserve the exact visual identity of the product from the source image. Keep the full product visible in the opening frame. Use a wider opening composition if necessary. Avoid starting too close. Do not crop the top of the head, body, base, or important product details. No identity drift across clips.';
        } elseif ( '9:16' === $format || '1:1' === $format ) {
            $format_direction = 'Vertical 9:16 commercial product video. Use the prepared 9:16 frame as the exact visual reference. Preserve the product exactly. Keep the product fully visible whenever possible and centered vertically with safe space at the top and base. The first frame must show the complete product without cutting the head, body, base, ring, support or display position. Animate the full environment with subtle realistic motion. The scene should feel like a real video recording, not a static image. Prefer eye-level or slight three-quarter product angles and avoid top-down camera moves or aggressive zoom. No black borders. No artificial frame inside frame. Use only a light natural zoom, push-in or slight parallax and never crop the product top, base, ring, support or display position.';
            $format_safety_lock = '9:16 product identity lock: Preserve the product exactly as the source image. Keep the same complete face, eyes, hair, clothing, pose, colors, material, finish, base, proportions and product identity. The product characters must keep complete facial features, including eyes, nose and mouth. The environment may animate naturally, but the product cannot transform, morph, change color, change pose, gain new details or become a different item.';
        }
        ...
        $mandatory_prompt = implode(
            ...
            array(
                ...
                'The product is the hero and must remain exactly identical to the source image. The product must remain exactly identical to the source image in every frame. The product from the input image is sacred. Do not modify the product shape, material, colors, size, texture, details, face, clothing, hair, pose, structure, printed elements, accessories, base, support, stand, ring, hook, attachment point, proportions or identity. Product characters must have complete and intact facial features. Preserve eyes, nose, mouth, face shape and all facial details. Do not remove eyes. Do not generate missing eyes. Do not simplify or distort the face. Do not create an incomplete face. Do not deform the characters. Do not add new product parts. Do not remove any product parts. Do not replace the product with a different object. Do not redesign the product. Do not stylize the product. Do not change the product into another version. Do not add props attached to the product. Do not invent product features. The product must look like the same physical item from the input image in every frame. For 3D printed personalized products, cake toppers, figurines, characters or wedding toppers: do not change faces, eyes, hair, clothing, body proportions, main pose, base, format, printed details or any personalized element. Do not transform it into a toy, tool, keychain, bottle opener, gadget, different figurine or another object.',
                'Scene animation:',
                'Animate the whole environment naturally, not only the camera. The scene should feel like a real video recording, not a static photo with camera motion. Keep the product stable and unchanged as the hero subject. Use a realistic product-filming style, as if a person is naturally filming the product in a real scene. Prefer eye-level or slight three-quarter product angles. Avoid top-down camera moves, strong overhead angles, vertical camera drops, aggressive push-ins at the start, synthetic zoom-only motion and unrealistic camera movement. Add gentle cinematic camera movement such as slow dolly, soft parallax, natural push-in or a very light handheld product-video feel. Background people may move subtly and naturally only if they are already present in the source image. Do not invent new crowds or make background people the main characters. Ambient lights can softly shimmer. Flowers, fabric, candles, reflections, depth, shadows or background details may have very subtle movement only if they exist in the source image. Keep wedding atmosphere elegant, soft and believable. Avoid overloading the scene with excessive candles, unnecessary decorative props, random objects or clutter. The environment should feel alive, premium and realistic, but never distracting. The main product must stay sharp, consistent and recognizable. No sudden scene changes. No object transformation. No product morphing. No new objects appearing. No fantasy animation.',
                'Visual direction:',
                ...
                'The first frame of every clip must show the full product clearly and completely. Keep the full product visible during the opening frame: top, head, face, body, base, support, ring, hook, stand, surface and every important product detail. Do not use a cropped opening shot. Do not crop the head, face, top, body, base, support, ring, hook, stand, surface or any important product detail. Start wider if necessary before any camera motion begins. Use stable camera movement, light natural motion, and a professional smartphone product-recording feel. ' . $format_direction,
    ...
    private static function video_clip_negative_prompt( $format = '' ) {
        $base = 'No crop at the first frame. No close-up at the first frame. No cropped opening shot. No product cut off. No head cut off. No body cut off. No base cut off. No missing eyes. No removed eyes. No incomplete face. No face distortion. No distorted facial features. No top-down filming. No overhead camera drop. No aggressive push-in at the start. No unrealistic zoom-only motion. No excessive candles. No cluttered wedding props. No unnecessary decorative props. No black bars. No frame inside frame. No static photo effect. No frozen background. No motionless environment. No product morphing. No product deformation. No product replacement. No new product features. No extra accessories. No text. No subtitles. No logos. No watermark. No UI overlay. No REC indicator. No camera HUD. No stickers. No glitter. No sparkles. No purple particles. No fantasy glow. No magic effects. No sudden scene cuts.';
        if ( '16:9' !== $format ) {
            return $base;
        }
